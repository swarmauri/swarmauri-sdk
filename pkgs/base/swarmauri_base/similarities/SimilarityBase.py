...
class SimilarityBase(ISimilarity, ComponentBase):
    ...
    def similarities(
        self,
        xs: Union[IVector, IMatrix, Sequence, str, Callable],
        ys: Union[IVector, IMatrix, Sequence, str, Callable],
        ...
        raise NotImplementedError(
            "similarities method must be implemented in a subclass"
        )
    ...
    def dissimilarity(
        ...
        raise NotImplementedError(
            "dissimilarity method must be implemented in a subclass"
        )
    ...
    def dissimilarities(
        ...
        raise NotImplementedError(
            "dissimilarities method must be implemented in a subclass"
        )
    ...
    def check_boundedness(self) -> bool:
        ...
        raise NotImplementedError(
            "check_boundedness method must be implemented in a subclass"
        )
    ...
    def check_reflexivity(self) -> bool:
        ...
        raise NotImplementedError(
            "check_reflexivity method must be implemented in a subclass"
        )
    ...
    def check_symmetry(self) -> bool:
        ...
        raise NotImplementedError(
            "check_symmetry method must be implemented in a subclass"
        )
    ...
    def check_identity(self) -> bool:
        ...
        raise NotImplementedError(
            "check_identity method must be implemented in a subclass"
        )
