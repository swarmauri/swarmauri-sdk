...
class EvalResultBase(IEvalResult, ComponentBase):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        -------
        Dict[str, Any]
            Dictionary representation of the evaluation result with keys:
            'score', 'metadata', and 'program'.
        """
        return {
            'score': self.score,
            'metadata': self.metadata,
            'program': self.program.to_dict() if hasattr(self.program, 'to_dict') else str(self.program)
        }
    
    def __str__(self) -> str:
        """
        Get string representation of the evaluation result.
