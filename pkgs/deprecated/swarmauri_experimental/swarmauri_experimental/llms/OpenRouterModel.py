...
class OpenRouterModel(LLMBase):
    ...
    allowed_models: List[str] = [
        ...
        # "google/gemini-flash-1.5-exp", # experimental model continues to
        # report 429 errors
        # "google/gemini-flash-8b-1.5-exp", # experimental model continues to
        # report 429 errors
        "google/gemini-pro",
        "google/gemini-pro-1.5",
        # "google/gemini-pro-1.5-exp", # experimental model continues to report
        # 429 errors
