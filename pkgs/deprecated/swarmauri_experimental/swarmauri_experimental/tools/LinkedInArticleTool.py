...
class LinkedInArticleTool(ToolBase):
    ...
    def __init__(self, access_token):
        ...
        Args:
            access_token (str): The OAuth access token for authenticating with
            the LinkedIn API.
        """
        super().__init__(
            name="LinkedInArticleTool",
    ...
    def __call__(
        self, title: str, text: str, visibility: str = "anyone"
    ) -> Dict[str, str]:
        """
        ...
        Args:
            ...
            visibility (str): The visibility of the article, either "anyone" or
            "connectionsOnly".
        ...
        Returns:
            ...
            LinkedIn API
        """
        # Construct the request URL and payload according to LinkedIn API
        # documentation
                    ...
                    "media": [
                        {
                            ...
                            "visibility": {
                                "com.linkedin.ugc.MemberNetworkVisibility": visibility.upper()  # noqa: E501
                            },
                        }
                    ],
                }
        ...
        if response.status_code == 201:
            return {
                "success": f"Article posted successfully: {response.json().get('id')}"  # noqa: E501
            }
        else:
            return {
                "error": (
                    f"Failed to post the article. Status Code: "
