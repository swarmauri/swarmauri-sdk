...
from swarmauri.embeddings.concrete.SpatialDocEmbedding import (
    SpatialDocEmbedding,
)
...
class SpatialDocVectorStore(
    ...
    def add_document(self, document: Document) -> None:
        self.add_documents(
            [document]
        )  # Reuse the add_documents logic for batch processing
    ...
    def update_document(self, id: str) -> None:
        raise NotImplementedError(
            "Update_document not implemented on SpatialDocVectorStore class."
        )
    ...
    def retrieve(self, query: str, top_k: int = 5) -> List[Document]:
        ...
        similarities = self._similarity.similarities(
