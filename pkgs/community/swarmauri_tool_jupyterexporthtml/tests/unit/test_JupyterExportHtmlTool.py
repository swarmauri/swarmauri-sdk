...
def test_jupyter_export_html_tool_call_basic(valid_notebook_json: str) -> None:
    ...
    assert "exported_html" in result, (
        "The result should contain 'exported_html'."
    )
...
def test_jupyter_export_html_tool_call_with_template(
...
def test_jupyter_export_html_tool_call_with_extra_js(
    valid_notebook_json: str,
) -> None:
    """
