...
<p align="center">
    <a href="https://pepy.tech/project/swarmauri_vectorstore_qdrant/">
        <img src="https://static.pepy.tech/badge/swarmauri_vectorstore_qdrant/month" alt="PyPI - Downloads"/></a>
    ...
    <a href="https://pypi.org/project/swarmauri_vectorstore_qdrant/">
        <img src="https://img.shields.io/pypi/l/swarmauri_vectorstore_qdrant" alt="License"/></a>
    <a href="https://pypi.org/project/swarmauri_vectorstore_qdrant/">
        <img src="https://img.shields.io/pypi/v/swarmauri_vectorstore_qdrant?label=swarmauri_vectorstore_qdrant&color=green" alt="Release Version"/></a>
...
```bash
uv add swarmauri_vectorstore_qdrant
```
...
```python
from swarmauri_vectorstore_qdrant import PersistentQdrantVectorStore, CloudQdrantVectorStore

exports = ['PersistentQdrantVectorStore', 'CloudQdrantVectorStore']
print(exports)
```
