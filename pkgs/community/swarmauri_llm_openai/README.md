...
<p align="center">
    ...
    <a href="https://pypi.org/project/swarmauri_llm_openai/">
        <img src="https://img.shields.io/pypi/l/swarmauri_llm_openai" alt="License"/></a>
    <a href="https://pypi.org/project/swarmauri_llm_openai/">
        <img src="https://img.shields.io/pypi/v/swarmauri_llm_openai?label=swarmauri_llm_openai&color=green" alt="Release Version"/></a>
    <a href="https://discord.gg/N4UpBuQv8T">
        <img src="https://img.shields.io/badge/Discord-Join%20Chat-5865F2?logo=discord&logoColor=white" alt="Discord"/></a>
</p>

# Swarmauri LLM OpenAI
...
- Provider-specific Swarmauri import package for OpenAI chat, reasoning, tool-calling, transcription, and text-to-speech workflows.
- Exposes discoverable runtime entry points for `swarmauri.llms, swarmauri.tool_llms` so the package can be wired into Swarmauri or Tigrbl workflows.
...
```python
from swarmauri_llm_openai import OpenAIAudio, OpenAIAudioTTS, OpenAIModel, OpenAIReasonModel

exports = ['OpenAIAudio', 'OpenAIAudioTTS', 'OpenAIModel', 'OpenAIReasonModel']
print(exports)
```
