...
<p align="center">
    ...
    <a href="https://pypi.org/project/swarmauri_llm_hyperbolic/">
        <img src="https://img.shields.io/pypi/l/swarmauri_llm_hyperbolic" alt="License"/></a>
    <a href="https://pypi.org/project/swarmauri_llm_hyperbolic/">
        <img src="https://img.shields.io/pypi/v/swarmauri_llm_hyperbolic?label=swarmauri_llm_hyperbolic&color=green" alt="Release Version"/></a>
    <a href="https://discord.gg/N4UpBuQv8T">
        <img src="https://img.shields.io/badge/Discord-Join%20Chat-5865F2?logo=discord&logoColor=white" alt="Discord"/></a>
</p>

# Swarmauri LLM Hyperbolic
...
```python
from swarmauri_llm_hyperbolic import HyperbolicAudioTTS, HyperbolicModel, HyperbolicVisionModel

exports = ['HyperbolicAudioTTS', 'HyperbolicModel', 'HyperbolicVisionModel']
print(exports)
```
