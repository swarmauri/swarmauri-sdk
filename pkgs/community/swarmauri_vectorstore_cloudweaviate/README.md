...
<p align="center">
    <a href="https://pepy.tech/project/swarmauri_vectorstore_cloudweaviate/">
        <img src="https://static.pepy.tech/badge/swarmauri_vectorstore_cloudweaviate/month" alt="PyPI - Downloads"/></a>
    ...
    <a href="https://pypi.org/project/swarmauri_vectorstore_cloudweaviate/">
        <img src="https://img.shields.io/pypi/l/swarmauri_vectorstore_cloudweaviate" alt="License"/></a>
    <a href="https://pypi.org/project/swarmauri_vectorstore_cloudweaviate/">
        <img src="https://img.shields.io/pypi/v/swarmauri_vectorstore_cloudweaviate?label=swarmauri_vectorstore_cloudweaviate&color=green" alt="Release Version"/></a>
...
```bash
uv add swarmauri_vectorstore_cloudweaviate
```
...
exports = ['CloudWeaviateVectorStore']
print(exports)
```
