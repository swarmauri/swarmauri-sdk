...
<p align="center">
    ...
    <a href="https://pypi.org/project/swarmauri_llm_groq/">
        <img src="https://img.shields.io/pypi/l/swarmauri_llm_groq" alt="License"/></a>
    <a href="https://pypi.org/project/swarmauri_llm_groq/">
        <img src="https://img.shields.io/pypi/v/swarmauri_llm_groq?label=swarmauri_llm_groq&color=green" alt="Release Version"/></a>
...
```python
from swarmauri_llm_groq import GroqAIAudio, GroqModel, GroqToolModel, GroqVisionModel

exports = ['GroqAIAudio', 'GroqModel', 'GroqToolModel', 'GroqVisionModel']
print(exports)
```
