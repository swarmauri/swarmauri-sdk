...
<p align="center">
    <a href="https://pepy.tech/project/swarmauri_vectorstore_persistentchromadb/">
        <img src="https://static.pepy.tech/badge/swarmauri_vectorstore_persistentchromadb/month" alt="PyPI - Downloads"/></a>
    ...
    <a href="https://pypi.org/project/swarmauri_vectorstore_persistentchromadb/">
        <img src="https://img.shields.io/pypi/l/swarmauri_vectorstore_persistentchromadb" alt="License"/></a>
    <a href="https://pypi.org/project/swarmauri_vectorstore_persistentchromadb/">
        <img src="https://img.shields.io/pypi/v/swarmauri_vectorstore_persistentchromadb?label=swarmauri_vectorstore_persistentchromadb&color=green" alt="Release Version"/></a>
...
```bash
uv add swarmauri_vectorstore_persistentchromadb
```
...
```python
from swarmauri_vectorstore_persistentchromadb import PersistentChromaDBVectorStore

exports = ['PersistentChromaDBVectorStore']
print(exports)
```
