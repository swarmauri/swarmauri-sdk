...
import pytest
from swarmauri_community.tools.concrete.GithubCommitTool import (
...
@pytest.fixture(scope="module")
def github_commit_tool(github_token):
...
@pytest.mark.unit
@patch("swarmauri_community.tools.concrete.GithubCommitTool.Github")
