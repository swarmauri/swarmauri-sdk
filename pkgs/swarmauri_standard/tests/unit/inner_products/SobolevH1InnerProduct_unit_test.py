...
class TestSobolevH1InnerProduct:
    ...
    def test_compute_constant_functions(
        self, sobolev_inner_product, mock_constant_vector
    ):
    ...
    def test_conjugate_symmetry(
        self, sobolev_inner_product, mock_linear_vector, mock_constant_vector
    ):
    ...
    def test_linearity(
        ...
        rhs = a * sobolev_inner_product.compute(
            x, z
        ) + b * sobolev_inner_product.compute(y, z)
