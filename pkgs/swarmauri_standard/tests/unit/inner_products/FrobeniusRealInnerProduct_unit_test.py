...
def test_check_linearity_first_argument(frobenius_inner_product):
    ...
    expected_add = frobenius_inner_product.compute(a, b) + frobenius_inner_product.compute(c, b)
    ...
    assert np.isclose(result_add, expected_add) and np.isclose(result_mult, expected_mult)
...
def test_check_linearity_second_argument(frobenius_inner_product):
    ...
    expected_add = frobenius_inner_product.compute(a, b) + frobenius_inner_product.compute(a, c)
