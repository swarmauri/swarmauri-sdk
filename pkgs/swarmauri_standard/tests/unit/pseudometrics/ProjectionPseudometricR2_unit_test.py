...
def test_type(projection_pseudometric_r2_parameterized):
    ...
    assert (
        projection_pseudometric_r2_parameterized.__class__.__name__
        == "ProjectionPseudometricR2"
    )
...
def test_str_repr(projection_pseudometric_r2_parameterized):
    ...
    assert str(projection_pseudometric_r2_parameterized).startswith(
        "ProjectionPseudometricR2"
    )
    assert repr(projection_pseudometric_r2_parameterized) == str(
        projection_pseudometric_r2_parameterized
    )
