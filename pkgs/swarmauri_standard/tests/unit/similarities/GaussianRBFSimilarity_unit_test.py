import pytest
from swarmauri_standard.swarmauri_standard.similarities.GaussianRBFSimilarity import GaussianRBFSimilarity
import logging
...
def test_gaussianrbf_similarity_symmetric():
    ...
    # Test with vector inputs
    assert similarity.similarity([1, 2], [3, 4]) == similarity.similarity([3, 4], [1, 2])