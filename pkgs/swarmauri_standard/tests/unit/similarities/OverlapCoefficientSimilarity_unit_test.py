...
def test_similarity_with_collections(overlap_similarity):
    ...
    # Lists
    assert abs(overlap_similarity.similarity([1, 2, 3], [2, 3, 4]) - 0.6666666666666666) < 1e-10
...
def test_similarity_with_duplicates(overlap_similarity):
    ...
    assert abs(overlap_similarity.similarity([1, 2, 2, 3], [2, 3, 3, 4]) - 0.6666666666666666) < 1e-10
...
def test_check_identity_of_discernibles(overlap_similarity):
    ...
    assert overlap_similarity.check_identity_of_discernibles({1, 2, 3}, {1, 2, 3}) is True
    ...
    assert overlap_similarity.check_identity_of_discernibles({1, 2, 3}, {2, 3, 4}) is True
