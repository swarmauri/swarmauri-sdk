...
class TestExponentialDistanceSimilarity:
    ...
    def test_dissimilarity(self):
        ...
        x = [0, 0, 0]
        y = [1, 1, 1]
        assert similarity_custom_scale.dissimilarity(x, y) > similarity.dissimilarity(x, y)
    ...
    def test_initialization(self):
        ...
        similarity_custom_distance = ExponentialDistanceSimilarity(distance_fn=custom_distance)
