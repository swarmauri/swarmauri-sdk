...
class TestValidation:
    ...
    def test_validate_input_different_dimensions(self, tanimoto_similarity):
        ...
        x = [1, 2, 3]
        y = [4, 5]
        with pytest.raises(ValueError, match="Input vectors must have the same dimensions"):
    ...
    def test_validate_input_zero_vectors(self, tanimoto_similarity):
        ...
        x = [0, 0, 0]
        y = [1, 2, 3]
        with pytest.raises(ValueError, match="Tanimoto similarity is not defined for zero vectors"):
            tanimoto_similarity._validate_input(x, y)
...
class TestSimilarity:
    ...
    @pytest.mark.parametrize("x, y, expected", [
        ...
        ([0.5, 0.5], [0.25, 0.75], 0.75)  # Real-valued vectors
    ])
...
class TestSimilarities:
    ...
    def test_similarities_with_errors(self, tanimoto_similarity):
        ...
        x = [1, 1, 1]
        ys = [[1, 1, 1], [1, 0], [0, 0, 0]]  # Second item has wrong dimension, third is zero vector
...
class TestProperties:
    ...
    def test_reflexivity(self, tanimoto_similarity, x):
        ...
        assert tanimoto_similarity.check_reflexivity(x) is True
    ...
    def test_symmetry(self, tanimoto_similarity, x, y):
        ...
        assert tanimoto_similarity.check_symmetry(x, y) is True
