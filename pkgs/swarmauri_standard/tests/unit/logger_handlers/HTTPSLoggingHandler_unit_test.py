...
def test_create_ssl_context_with_custom_settings(mock_create_context):
    ...
    handler = HTTPSLoggingHandler(
        ssl_context={"options": ssl.OP_NO_TLSv1, "minimum_version": ssl.TLSVersion.TLSv1_2}
    )
...
def test_send_log_error_response(mock_get_logger, mock_stream_handler, mock_request, mock_url