...
import http.client
from swarmauri_standard.logger_handlers.HTTPLoggingHandler import HTTPLoggingHandler, HTTPHandlerExtended
...
class TestHTTPHandlerExtended:
    ...
    @mock.patch('http.client.HTTPConnection')
    def test_emit_with_credentials(self, mock_http_connection):
        """Test that emit adds basic auth headers when credentials are provided."""
