...
class TestAbsoluteValueMetric:
    ...
    def test_check_triangle_inequality_happy_path(self, absolute_value_metric, x, y, z, expected):
    ...
    def test_check_triangle_inequality_multiple_cases(self, absolute_value_metric, x, y, z):
