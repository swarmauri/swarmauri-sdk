...
class TestL2EuclideanNorm:
    ...
    def test_compute_method(self, setup_l2_norm, input_vector, expected_norm):
        ...
        logger.info(
            f"Compute method test with input {input_vector} completed successfully"
        )
    ...
    def test_check_absolute_homogeneity(self, setup_l2_norm, scale_factor):
        ...
        logger.info(
            f"Absolute homogeneity property test with scale factor {scale_factor} completed successfully"
        )
