...
# # List of distances names (file names without the ".py" extension) and
...
#     ("swarmauri_standard.distances.ChiSquaredDistance", "ChiSquaredDistance"),  # noqa: E501
...
#     ("swarmauri_standard.distances.LevenshteinDistance", "LevenshteinDistance"),  # noqa: E501
