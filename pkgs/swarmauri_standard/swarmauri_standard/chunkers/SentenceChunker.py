...
class SentenceChunker(ChunkerBase):
    ...
    This class uses basic punctuation marks (., !, and ?) as indicators for
    sentence boundaries.
    """
    ...
    def chunk_text(self, text: str, *args: Any, **kwargs: Any) -> List[str]:
        ...
        """
        # Split text using a simple regex pattern that looks for periods,
        # exclamation marks, or question marks.
        # Note: This is a very simple approach and might not work well with
