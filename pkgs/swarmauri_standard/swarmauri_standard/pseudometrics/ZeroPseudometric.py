...
class ZeroPseudometric(PseudometricBase):
    ...
    def distance(self, x: Union[VectorType, MatrixType, Sequence[T], str, Callable], 
        ...
        float
            Always returns 0.0
        """
        logger.debug(f"Computing ZeroPseudometric distance between objects of types {type(x)} and {type(y)}")
        return 0.0
    ...
    def distances(self, xs: Sequence[Union[VectorType, MatrixType, Sequence[T], str, Callable]], 
        ...
        """
        logger.debug(f"Computing pairwise ZeroPseudometric distances between {len(xs)} and {len(ys)} objects")
    ...
    def check_non_negativity(self, x: Union[VectorType, MatrixType, Sequence[T], str, Callable],
        ...
        bool
            Always returns True
        """
        logger.debug(f"Checking non-negativity for ZeroPseudometric with objects of types {type(x)} and {type(y)}")
    ...
    def check_symmetry(self, x: Union[VectorType, MatrixType, Sequence[T], str, Callable],
        ...
        bool
            Always returns True
        """
        logger.debug(f"Checking symmetry for ZeroPseudometric with objects of types {type(x)} and {type(y)}")
    ...
    def check_triangle_inequality(self, x: Union[VectorType, MatrixType, Sequence[T], str, Callable],
        ...
        bool
            Always returns True
        """
        logger.debug(f"Checking triangle inequality for ZeroPseudometric with objects of types {type(x)}, {type(y)}, and {type(z)}")
    ...
    def check_weak_identity(self, x: Union[VectorType, MatrixType, Sequence[T], str, Callable],
        ...
        bool
            Always returns True
        """
        logger.debug(f"Checking weak identity for ZeroPseudometric with objects of types {type(x)} and {type(y)}")
