...
class MeanMeasurement(
    MeasurementAggregateMixin, MeasurementCalculateMixin, MeasurementBase
):
    """
    A measurement that calculates the mean (average) of a list of numerical
    values.

    Attributes:
        name (str): The name of the measurement.
        unit (str): The unit of measurement for the mean (e.g., "degrees",
        "points").
        _value (float): The calculated mean of the measurements.
        _measurements (list): A list of measurements (numerical values) to
        average.
    """
    ...
    def add_measurement(self, measurement: int) -> None:
        ...
        Args:
            measurement (float): A numerical value to be added to the list of
            measurements.
        """
    ...
    def calculate(self) -> float:
        ...
        Returns:
            float: The mean of the measurements or None if no measurements have
            been added.
        """
