...
class WeightedL2InnerProduct(InnerProductBase):
    ...
    def check_conjugate_symmetry(self, a: Union[object, object], b: Union[object, object]) -> bool:
        ...
        try:
            ...
            if isinstance(inner_product_ab, (float, np.floating)) or isinstance(inner_product_ab, (complex, np.complex_)):
    ...
    def check_linearity_first_argument(self, a: Union[object, object], b: Union[object, object], c: Union[object, object]) -> bool:
        ...
        try:
            ...
            return (np.isclose(inner_product_add, inner_product_sum) and 
                    np.isclose(inner_product_scale, inner_product_scaled))
