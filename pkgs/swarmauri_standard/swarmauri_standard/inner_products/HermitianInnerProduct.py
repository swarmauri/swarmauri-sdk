...
class HermitianInnerProduct(InnerProductBase):
    ...
    def compute(self, a: Union[np.ndarray, complex], b: Union[np.ndarray, complex]) -> Union[float, complex]:
        ...
        if not isinstance(a, (np.ndarray, complex)) or not isinstance(b, (np.ndarray, complex)):
    ...
    def check_conjugate_symmetry(self, a: Union[np.ndarray, complex], b: Union[np.ndarray, complex]) -> bool:
    ...
    def check_linearity_first_argument(self, a: Union[np.ndarray, complex], b: Union[np.ndarray, complex], c: Union[np.ndarray, complex]) -> bool:
