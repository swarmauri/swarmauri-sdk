...
class ExponentialDistanceSimilarity(SimilarityBase):
    ...
    def _default_distance(self, x: Union[Sequence, np.ndarray], y: Union[Sequence, np.ndarray]) -> float:
        """
    ...
    def similarity(self, x: Union[Sequence, np.ndarray], y: Union[Sequence, np.ndarray]) -> float:
        """
    ...
    def similarities(self, xs: Union[Sequence, np.ndarray], ys: Union[Sequence, np.ndarray]) -> Union[float, Sequence[float]]:
        """
    ...
    def dissimilarity(self, x: Union[Sequence, np.ndarray], y: Union[Sequence, np.ndarray]) -> float:
        """
    ...
    def dissimilarities(self, xs: Union[Sequence, np.ndarray], ys: Union[Sequence, np.ndarray]) -> Union[float, Sequence[float]]:
        """
