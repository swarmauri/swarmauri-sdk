...
class CosineSimilarity(SimilarityBase):
    ...
    def similarities(self, xs: Union[Sequence[Union[Sequence[float], str]], Sequence[float], str],
                     ys: Union[Sequence[Union[Sequence[float], str]], Sequence[float], str]) -> Union[float, Sequence[float]]:
        """
    ...
    def dissimilarity(self, x: Union[Sequence[float], str], y: Union[Sequence[float], str]) -> float:
        """
    ...
    def dissimilarities(self, xs: Union[Sequence[Union[Sequence[float], str]], Sequence[float], str],
                       ys: Union[Sequence[Union[Sequence[float], str]], Sequence[float], str]) -> Union[float, Sequence[float]]:
        """
