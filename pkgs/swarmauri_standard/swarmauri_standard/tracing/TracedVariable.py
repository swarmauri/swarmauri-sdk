...
class TracedVariable:
    """
    Wrapper class to trace multiple changes to a variable within the context
    manager.
    """
    ...
    def value(self, new_value: Any):
        ...
        # Update the trace by appending the latest change to the list under a
        # single key
        # Note that the key is now constant and does not change with each
        # update
