...
This module defines the CalculatorTool, a component that performs basic
...
The CalculatorTool supports addition, subtraction, multiplication, and division
operations,
taking two numerical operands as input and returning the result of the
specified operation.
"""
...
class CalculatorTool(ToolBase):
    """
    CalculatorTool is a tool that performs basic arithmetic operations such as
    addition,
    ...
    parameters: List[Parameter] = Field(
        default_factory=lambda: [
            Parameter(
                ...
                input_type="string",
                description=(
                    "The arithmetic operation to perform ('add', 'subtract', "
                    "'multiply', 'divide')."
                ),
                required=True,
    ...
    def __call__(self, operation: str, x: float, y: float) -> Dict[str, str]:
        ...
        Args:
            operation (str): The arithmetic operation to perform. Must be one
            of
        ...
        Returns:
            Dict[str, str]: A dictionary containing the operation performed and
            the result
                            as a string. If an error occurs (e.g., division by
                            zero or
                            unknown operation), an error message is returned
                            instead.
