import pytest
import os
from swarmauri.standard.llms.concrete.GroqToolModel import GroqToolModel as LLM
...
def test_default_name():
    ...
    assert model.name == "llama3-groq-70b-8192-tool-use-preview"
