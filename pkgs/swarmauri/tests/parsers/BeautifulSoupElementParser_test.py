import pytest
from swarmauri.standard.documents.concrete import Document
...
@pytest.mark.parametrize(
    ...
    [
        ("<div><p>First paragraph</p><p>Second paragraph</p></div>", "p", 2,
         ['<p>First paragraph</p>', '<p>Second paragraph</p>']),
        ("<div><span>Some span content</span></div>", "span", 1, ['<span>Some span content</span>']),
