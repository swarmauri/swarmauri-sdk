...
class PluginCitizenshipRegistry:
    ...
    @classmethod
    def add_to_registry(cls, class_type: str, resource_path: str, module_path: str) -> None:
        """
        ...
        if class_type not in registry_map:
            logger.error(f"Invalid class type '{class_type}'. Must be 'first', 'second', or 'third'.")
        ...
        if resource_path in registry:
            logger.error(f"Resource path '{resource_path}' already exists in the {class_type}-class registry.")
    ...
    def remove_from_registry(cls, class_type: str, resource_path: str) -> None:
        ...
        if resource_path not in registry:
            logger.error(f"Resource path '{resource_path}' does not exist in the {class_type}-class registry.")
    ...
    @classmethod
    def update_entry(cls, class_type: str, resource_path: str, new_module_path: str) -> None:
        """
    ...
    def is_first_class(cls, entry_point: EntryPoint) -> bool:
        ...
        logger.debug(f"Plugin '{entry_point.name}' is {'first-class' if is_first else 'not first-class'}.")
        return is_first
    ...
    def is_second_class(cls, entry_point: EntryPoint) -> bool:
        ...
        logger.debug(f"Plugin '{entry_point.name}' is {'second-class' if is_second else 'not second-class'}.")
        return is_second
