...
class PluginCitizenshipRegistry:
    ...
    FIRST_CLASS_REGISTRY: Dict[str, str] = {
        ...
        "swarmauri.vcms.FalVCM": "swarmauri_standard.vcm.GroqVCM",
        "swarmauri.vcms.GroqVCM": "swarmauri_standard.vcm.GroqOCR",
        "swarmauri.vcm.HyperbolicVCM": "swarmauri_standard.vcm.HyperbolicVCM",
