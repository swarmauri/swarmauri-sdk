...
class SwarmauriImporter:
    ...
    def find_spec(self, fullname, path=None, target=None):
        ...
        if fullname == "swarmauri" or fullname.startswith("swarmauri."):
            ...
            if len(namespace_parts) == 2 and fullname not in sys.modules and fullname in self.VALID_NAMESPACES:
    ...
    def create_module(self, spec):
        ...
        external_module_path = PluginCitizenshipRegistry.get_external_module_path(spec.name)
        if external_module_path:
