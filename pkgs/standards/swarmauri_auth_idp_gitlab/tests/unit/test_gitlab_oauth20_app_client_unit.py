...
from swarmauri_auth_idp_gitlab import GitLabOAuth20AppClient
...
@pytest.fixture
def client() -> GitLabOAuth20AppClient:
    return GitLabOAuth20AppClient(
...
@pytest.mark.unit
def test_resource(client: GitLabOAuth20AppClient) -> None:
    assert client.resource == "OAuth20AppClient"


@pytest.mark.unit
def test_type(client: GitLabOAuth20AppClient) -> None:
    assert client.type == "GitLabOAuth20AppClient"


@pytest.mark.unit
@pytest.mark.asyncio
async def test_access_token_cached(client: GitLabOAuth20AppClient) -> None:
...
@pytest.mark.unit
@pytest.mark.asyncio
async def test_access_token_refreshes(client: GitLabOAuth20AppClient) -> None:
