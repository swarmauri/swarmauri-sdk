"""GitLab OAuth 2.1 client credentials app client implementation."""
...
@ComponentBase.register_type(OAuth21AppClientBase, "GitLabOAuth21AppClient")
class GitLabOAuth21AppClient(OAuth21AppClientBase):
    """Request OAuth 2.1 client credentials tokens from GitLab."""
