...
@ComponentBase.register_type(ToolBase, "RemoveToolFromToolkitTool")
class RemoveToolFromToolkitTool(ToolBase):
    version: str = "0.1.0"
    name: str = "RemoveToolFromToolkitTool"
    description: str = "Delete a non-reserved tool from the active toolkit."
    type: Literal["RemoveToolFromToolkitTool"] = "RemoveToolFromToolkitTool"
