...
@ComponentBase.register_type(ToolBase, "GetToolFromToolkitTool")
class GetToolFromToolkitTool(ToolBase):
    version: str = "0.1.0"
    name: str = "GetToolFromToolkitTool"
    description: str = "Read one tool from the active toolkit by name."
    type: Literal["GetToolFromToolkitTool"] = "GetToolFromToolkitTool"
