...
<p align="center">
    <a href="https://pepy.tech/project/swarmauri_tokens_sshcert/">
        <img src="https://static.pepy.tech/badge/swarmauri_tokens_sshcert/month" alt="PyPI - Downloads"/></a>
    ...
    <a href="https://pypi.org/project/swarmauri_tokens_sshcert/">
        <img src="https://img.shields.io/pypi/l/swarmauri_tokens_sshcert" alt="License"/></a>
    <a href="https://pypi.org/project/swarmauri_tokens_sshcert/">
        <img src="https://img.shields.io/pypi/v/swarmauri_tokens_sshcert?label=swarmauri_tokens_sshcert&color=green" alt="Release Version"/></a>
    <a href="https://discord.gg/N4UpBuQv8T">
        <img src="https://img.shields.io/badge/Discord-Join%20Chat-5865F2?logo=discord&logoColor=white" alt="Discord"/></a>
</p>

# Swarmauri Tokens SSH Cert
...
```bash
uv add swarmauri_tokens_sshcert
```

```bash
pip install swarmauri_tokens_sshcert
```
