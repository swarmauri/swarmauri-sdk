...
<p align="center">
    ...
    <a href="https://pypi.org/project/swarmauri_transport_h2mux/">
        <img src="https://img.shields.io/pypi/l/swarmauri_transport_h2mux" alt="License"/></a>
    <a href="https://pypi.org/project/swarmauri_transport_h2mux/">
        <img src="https://img.shields.io/pypi/v/swarmauri_transport_h2mux?label=swarmauri_transport_h2mux&color=green" alt="Release Version"/></a>
    <a href="https://discord.gg/N4UpBuQv8T">
        <img src="https://img.shields.io/badge/Discord-Join%20Chat-5865F2?logo=discord&logoColor=white" alt="Discord"/></a>
</p>

# Swarmauri Transport HTTP/2 Mux
...
- Core HTTP/2 multiplexer transport for Swarmauri agents.
- Centers its public API around `H2MuxTransport` so downstream code can import the package directly without extra registry glue.
...
```bash
uv add swarmauri_transport_h2mux
```

```bash
pip install swarmauri_transport_h2mux
```
