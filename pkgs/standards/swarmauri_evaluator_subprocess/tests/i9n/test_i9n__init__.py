...
def test_version_attribute():
    ...
    assert hasattr(swarmauri_evaluator_subprocess, '__version__'), "Package missing __version__ attribute"
    
    # Check that version is a string
    assert isinstance(swarmauri_evaluator_subprocess.__version__, str), "Package __version__ is not a string"
...
def test_all_attribute():
    ...
    assert hasattr(swarmauri_evaluator_subprocess, '__all__'), "Package missing __all__ attribute"
    
    # Check that __all__ is a list or tuple
    assert isinstance(swarmauri_evaluator_subprocess.__all__, (list, tuple)), "__all__ is not a list or tuple"
    
    # Check that SubprocessEvaluator is in __all__
    assert "SubprocessEvaluator" in swarmauri_evaluator_subprocess.__all__, "SubprocessEvaluator not in __all__"
...
def test_package_reload(reload_package):
    ...
    assert hasattr(reload_package, 'SubprocessEvaluator'), "Reloaded package missing SubprocessEvaluator"
