...
<p align="center">
    ...
    <a href="https://pypi.org/project/swarmauri_transport_sshtunnel/">
        <img src="https://img.shields.io/pypi/l/swarmauri_transport_sshtunnel" alt="License"/></a>
    <a href="https://pypi.org/project/swarmauri_transport_sshtunnel/">
        <img src="https://img.shields.io/pypi/v/swarmauri_transport_sshtunnel?label=swarmauri_transport_sshtunnel&color=green" alt="Release Version"/></a>
...
- SSH tunnel transport for forwarding Swarmauri traffic through bastions.
- Centers its public API around `SSHTunnelTransport` so downstream code can import the package directly without extra registry glue.
...
```bash
uv add swarmauri_transport_sshtunnel
```

```bash
pip install swarmauri_transport_sshtunnel
```
