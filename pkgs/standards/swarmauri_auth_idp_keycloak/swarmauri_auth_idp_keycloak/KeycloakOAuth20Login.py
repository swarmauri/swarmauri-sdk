"""Keycloak OAuth 2.0 Authorization Code login implementation."""
...
@ComponentBase.register_type(OAuth20LoginBase, "KeycloakOAuth20Login")
class KeycloakOAuth20Login(KeycloakOAuthLoginMixin, OAuth20LoginBase):
    """Implement the Keycloak OAuth 2.0 Authorization Code flow with PKCE."""
