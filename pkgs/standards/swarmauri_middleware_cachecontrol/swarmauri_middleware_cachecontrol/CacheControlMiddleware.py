...
from core.ComponentBase import ComponentBase
...
class CacheControlMiddleware(MiddlewareBase, ComponentBase):
    ...
    type: Literal["CacheControlMiddleware"] = "CacheControlMiddleware"
    max_age: int = 3600
    enabled: bool = True
    ...
    async def _handle_conditional_request(self, request: Request, response: Response) -> bool:
    ...
    async def _send_not_modified(self, response: Response) -> bool:
        ...
        self.logger.info("Sent 304 Not Modified response")
        return True