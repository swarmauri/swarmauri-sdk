...
def precedence_for_phase(p: Phase, *, api: HookMap|None, table: HookMap|None,
                         op: HookMap|None, imperative: HookMap|None) -> Tuple[Callable, ...]:
    pre_like   = {Phase.PRE_TX_BEGIN, Phase.PRE_HANDLER, Phase.PRE_COMMIT}
    post_like  = {Phase.POST_HANDLER, Phase.POST_COMMIT, Phase.POST_RESPONSE, Phase.FINAL}
    error_like = {
        Phase.ON_ROLLBACK, Phase.ON_PRE_HANDLER_ERROR, Phase.ON_HANDLER_ERROR,
        Phase.ON_POST_HANDLER_ERROR, Phase.ON_PRE_COMMIT_ERROR, Phase.ON_COMMIT_ERROR,
        Phase.ON_POST_COMMIT_ERROR, Phase.ON_POST_RESPONSE_ERROR, Phase.ON_ERROR
    }
