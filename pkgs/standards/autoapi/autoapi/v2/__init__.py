...
class _Namespace(SimpleNamespace):
    """Simple container namespace that hides private attributes."""
...
class AutoAPI:
    ...
    def __init__(
        ...
        *,
        ...
        # Cores
        self.core: _Namespace = _Namespace("core")
        self.core_raw: _Namespace = _Namespace("core_raw")
        ...
        self.methods: _Namespace = _Namespace("methods")
