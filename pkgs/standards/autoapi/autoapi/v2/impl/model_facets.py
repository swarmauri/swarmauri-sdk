...
def init_model_facets(model: Type) -> None:
    ...
    ns.config = SimpleNamespace(
        defaults_mode=getattr(model, "__autoapi_defaults_mode__", "all"),
        defaults_include=getattr(model, "__autoapi_defaults_include__", set()),
        defaults_exclude=getattr(model, "__autoapi_defaults_exclude__", set()),
        verb_aliases=dict((getattr(model, "__autoapi_verb_aliases__", {}) or {})),
        verb_alias_policy=getattr(model, "__autoapi_verb_alias_policy__", "both"),
