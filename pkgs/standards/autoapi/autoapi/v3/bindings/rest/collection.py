...
from ...core.crud.helpers import _colspecs
        ...
        async def _endpoint(
            ...
            **kw: Any,
            ...
            if (
                ...
                pv = temp.setdefault("paired_values", {})
                alias_name = (
                    getattr(
                        _colspecs(model).get("digest").io._paired, "alias", "digest"
                    )  # type: ignore[union-attr]
                )
                pv["digest"] = {"raw": pair.raw, "alias": alias_name}
