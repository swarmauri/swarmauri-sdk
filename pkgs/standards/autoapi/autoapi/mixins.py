...
from sqlalchemy import (
    Column, String, DateTime, Enum as SAEnum,
    Numeric, JSON, Float, Index, ForeignKey
)
from sqlalchemy.dialects.postgresql import UUID, JSONB, TSVECTOR
from sqlalchemy.ext.declarative import declarative_mixin, declared_attr
...
# ────────── Bulk Operations ---------------------------------------------
@declarative_mixin
class BulkCapable:   pass


# ────────── Enable PUT METHOD ------------------------------------------
@declarative_mixin
class Replaceable:   pass      # described earlier
