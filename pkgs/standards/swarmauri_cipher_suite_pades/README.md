...
<p align="center">
    <a href="https://pepy.tech/project/swarmauri_cipher_suite_pades/">
        <img src="https://static.pepy.tech/badge/swarmauri_cipher_suite_pades/month" alt="PyPI - Downloads"/></a>
    <a href="https://hits.sh/github.com/swarmauri/swarmauri-sdk/tree/master/pkgs/standards/swarmauri_cipher_suite_pades/">
        <img alt="Hits" src="https://hits.sh/github.com/swarmauri/swarmauri-sdk/tree/master/pkgs/standards/swarmauri_cipher_suite_pades.svg"/></a>
    <a href="https://pypi.org/project/swarmauri_cipher_suite_pades/">
        <img src="https://img.shields.io/pypi/pyversions/swarmauri_cipher_suite_pades" alt="PyPI - Python Version"/></a>
    <a href="https://pypi.org/project/swarmauri_cipher_suite_pades/">
        <img src="https://img.shields.io/pypi/l/swarmauri_cipher_suite_pades" alt="PyPI - License"/></a>
    <a href="https://pypi.org/project/swarmauri_cipher_suite_pades/">
...
```bash
pip install swarmauri_cipher_suite_pades
```

### Poetry

```bash
poetry add swarmauri_cipher_suite_pades
```
...
```bash
uv add swarmauri_cipher_suite_pades
```

Or install it into the active environment:

```bash
uv pip install swarmauri_cipher_suite_pades
```
