...
<p align="center">
    ...
    <a href="https://pypi.org/project/swarmauri_prompt_j2prompttemplate/">
        <img src="https://img.shields.io/pypi/l/swarmauri_prompt_j2prompttemplate" alt="License"/></a>
    <a href="https://pypi.org/project/swarmauri_prompt_j2prompttemplate/">
        <img src="https://img.shields.io/pypi/v/swarmauri_prompt_j2prompttemplate?label=swarmauri_prompt_j2prompttemplate&color=green" alt="Release Version"/></a>
...
- Jinja2 Prompt Template for Swarmauri.
- Exposes discoverable runtime entry points for `swarmauri.prompts` so the package can be wired into Swarmauri or Tigrbl workflows.
