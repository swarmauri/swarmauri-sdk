...
@ComponentBase.register_type(OCRBase, "GroqOCR")
class GroqOCR(OCRBase):
    """
    GroqOCR class for interacting with the Groq vision language models API. This class
