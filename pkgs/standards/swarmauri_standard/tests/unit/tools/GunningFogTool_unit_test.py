import pytest
from swarmauri_standard.tools.GunningFogTool import GunningFogTool as Tool
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "Another example with more complex sentences; used for testing.",
            3,
            10,
            2,
            16.93,
        ...
        (
            "Punctuation-heavy text! Is it really? Yes, it is! 42",
            5,
            10,
            1,
            5.0,
...
def test_call(
    input_text,
    num_of_major_punctuations,
    num_of_words,
    num_of_three_plus_syllable_words,
    expected_score,
):
    tool = Tool()
    ...
    assert isinstance(
        result.get("gunning_fog_score"), float
