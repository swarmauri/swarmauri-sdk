...
<p align="center">
    ...
    <a href="https://pypi.org/project/swarmauri_evaluatorpool_accessibility/">
        <img src="https://img.shields.io/pypi/l/swarmauri_evaluatorpool_accessibility" alt="License"/></a>
    <a href="https://pypi.org/project/swarmauri_evaluatorpool_accessibility/">
        <img src="https://img.shields.io/pypi/v/swarmauri_evaluatorpool_accessibility?label=swarmauri_evaluatorpool_accessibility&color=green" alt="Release Version"/></a>
...
- A package providing accessibility and readability evaluators for SwarmAuri.
- Exposes discoverable runtime entry points for `swarmauri.evaluator_pools, swarmauri.evaluators` so the package can be wired into Swarmauri or Tigrbl workflows.
...
```python
from swarmauri_evaluatorpool_accessibility import AutomatedReadabilityIndexEvaluator, ColemanLiauIndexEvaluator, FleschKincaidGradeEvaluator, FleschReadingEaseEvaluator

exports = ['AutomatedReadabilityIndexEvaluator', 'ColemanLiauIndexEvaluator', 'FleschKincaidGradeEvaluator', 'FleschReadingEaseEvaluator']
print(exports)
```
