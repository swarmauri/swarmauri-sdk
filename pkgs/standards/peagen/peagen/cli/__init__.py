...
local_app.add_typer(local_eval_app,                name="eval")
local_app.add_typer(local_extras_app,                    name="extras-schemas")
local_app.add_typer(local_fetch_app,                     name="fetch")
local_app.add_typer(local_init_app,                      name="init")
local_app.add_typer(local_sort_app,          name="sort")
...
remote_app.add_typer(remote_eval_app,               name="eval")
remote_app.add_typer(remote_fetch_app,                     name="fetch")
remote_app.add_typer(remote_process_app,                   name="process")
remote_app.add_typer(remote_sort_app,        name="sort")
