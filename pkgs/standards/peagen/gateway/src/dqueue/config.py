...
class Settings(BaseSettings):
    ...
    redis_password: str = Field(default=os.environ["REDIS_PASSWORD"])
    ...
    pg_host: str = Field(default=os.environ.get("PG_HOST"))
    pg_port: int = Field(default=int(os.environ.get("PG_PORT", "5342")))
    pg_db: str = Field(default=os.environ["PG_DB"])
    pg_user: str = Field(default=os.environ["PG_USER"])
    pg_pass: str = Field(default=os.environ["PG_PASS"])
