...
<p align="center">
    ...
    <a href="https://pypi.org/project/swarmauri_auth_idp_gitea/">
        <img src="https://img.shields.io/pypi/l/swarmauri_auth_idp_gitea" alt="License"/></a>
    <a href="https://pypi.org/project/swarmauri_auth_idp_gitea/">
        <img src="https://img.shields.io/pypi/v/swarmauri_auth_idp_gitea?label=swarmauri_auth_idp_gitea&color=green" alt="Release Version"/></a>
...
```python
from swarmauri_auth_idp_gitea import GiteaOAuth20AppClient, GiteaOAuth20Login, GiteaOAuth21AppClient, GiteaOAuth21Login

exports = ['GiteaOAuth20AppClient', 'GiteaOAuth20Login', 'GiteaOAuth21AppClient', 'GiteaOAuth21Login']
print(exports)
```
