"""Gitea OAuth 2.0 Authorization Code login implementation."""
...
@ComponentBase.register_type(OAuth20LoginBase, "GiteaOAuth20Login")
class GiteaOAuth20Login(GiteaOAuthLoginMixin, OAuth20LoginBase):
    """Implement OAuth 2.0 Authorization Code with PKCE for Gitea."""
