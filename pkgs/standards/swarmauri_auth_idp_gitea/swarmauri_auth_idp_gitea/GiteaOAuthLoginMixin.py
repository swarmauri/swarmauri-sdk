"""Shared helpers for Gitea OAuth user login implementations."""
...
class GiteaOAuthLoginMixin:
    """PKCE, HTTP, and profile helpers reused by Gitea OAuth logins."""
