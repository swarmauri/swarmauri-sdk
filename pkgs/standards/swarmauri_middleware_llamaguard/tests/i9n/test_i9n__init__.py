...
class TestInit:
    ...
    def test_all(self):
        ...
        assert mod.__all__ == ["LlamaGuardMiddleware"], "__all__ contains unexpected values"
    ...
    def test_llamaguardmiddleware_import(self):
        ...
        assert isinstance(LlamaGuardMiddleware, type), "LlamaGuardMiddleware is not a class"
