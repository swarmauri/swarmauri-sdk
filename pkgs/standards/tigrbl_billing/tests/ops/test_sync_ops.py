...
def test_sync_objects_updates_existing_records():
    ...
    result = sync_ops.sync_objects(
        ...
        engine_ctx=None,
        schema_ctx=None,
        products=[{"external_id": "prod_2", "name": "New", "description": "Newer"}],
    )
