...
from tigrbl.types import Mapped, Integer, String, JSONB, UniqueConstraint, CheckConstraint, PgUUID, UUID
...
class SubscriptionItem(Base, GUIDPk, Timestamped):
    ...
    __table_args__ = (
        UniqueConstraint("stripe_subscription_item_id", name="uq_si_stripe_subscription_item_id"),
        CheckConstraint("quantity IS NULL OR quantity >= 0", name="ck_si_quantity_nonneg"))
