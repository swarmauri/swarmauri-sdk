...
from tigrbl.types import Mapped, String, Integer, JSONB, Boolean, SAEnum, UniqueConstraint, UUID, PgUUID
...
class CustomerBalance(Base, GUIDPk, Timestamped, ActiveToggle):
    ...
    __table_args__ = (
        UniqueConstraint("customer_id", "currency", name="uq_customer_balance_customer_currency"))
