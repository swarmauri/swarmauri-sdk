...
from tigrbl.types import Mapped, String, SAEnum, TZDateTime, UniqueConstraint, PgUUID, UUID
...
class SeatAllocation(Base, GUIDPk, Timestamped):
    ...
    __table_args__ = (
        UniqueConstraint("subscription_item_id", "subject_ref", name="uq_seat_unique_assignment"))
