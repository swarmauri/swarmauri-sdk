...
@op_ctx(alias="finalize", target="custom", arity="member", bind=Invoice, persist="default")
async def finalize_invoice(
    *, invoice_id, line_items: Optional[Sequence[Mapping[str, object]]]=None,
    model=None, ctx=None, payload=None, spec=None,
) -> dict:
    ...
    if line_items is not None:
        body['line_items'] = list(line_items)  # handlers/schemas may map this to child ops
    ctx['payload'] = body
...
@op_ctx(alias="mark_uncollectible", target="custom", arity="member", bind=Invoice, persist="default")
