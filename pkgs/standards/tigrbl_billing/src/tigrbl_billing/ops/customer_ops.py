...
@op_ctx(alias="create_or_link_customer", target="custom", arity="collection", bind=Customer, persist="default")
async def create_or_link_customer(
    *, email: Optional[str]=None, name: Optional[str]=None,
    ...
    tax_exempt: str='none', metadata: Optional[dict]=None,
    active: bool=True,
...
@op_ctx(alias="attach_payment_method", target="custom", arity="member", bind=Customer, persist="default")
async def attach_payment_method(
    *, customer_id, payment_method_ref: str,
    model=None, ctx=None, payload=None, spec=None,
) -> dict:
