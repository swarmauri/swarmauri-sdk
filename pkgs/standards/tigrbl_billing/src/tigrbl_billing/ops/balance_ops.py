...
from tigrbl_billing.tables.balance_top_off import BalanceTopOff, TopOffTrigger, TopOffMethod, TopOffStatus
from tigrbl_billing.tables.customer_balance import CustomerBalance

@op_ctx(alias="request_top_off", target="custom", arity="collection", bind=CustomerBalance, persist="default")
async def request_top_off(*, balance_id, amount: int, currency: str, trigger: str="manual", method: str="payment_intent", metadata: dict | None=None, model=None, ctx=None, **_) -> dict:
    ctx['payload'] = {
...
@op_ctx(alias="check_and_top_off", target="custom", arity="member", bind=CustomerBalance, persist="skip")
...
@op_ctx(alias="apply_top_off", target="custom", arity="member", bind=BalanceTopOff, persist="default")
async def apply_top_off(*, top_off_id=None, status: str | None=None, failure_reason: str | None=None, processed_at=None, metadata: dict | None=None, model=None, ctx=None, **_):
