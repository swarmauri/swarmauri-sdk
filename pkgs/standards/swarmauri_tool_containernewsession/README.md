...
<p align="center">
    ...
    <a href="https://pypi.org/project/swarmauri_tool_containernewsession/">
        <img src="https://img.shields.io/pypi/l/swarmauri_tool_containernewsession" alt="License"/></a>
    <a href="https://pypi.org/project/swarmauri_tool_containernewsession/">
        <img src="https://img.shields.io/pypi/v/swarmauri_tool_containernewsession?label=swarmauri_tool_containernewsession&color=green" alt="Release Version"/></a>
...
```bash
uv add swarmauri_tool_containernewsession
```
...
exports = ['ContainerNewSessionTool']
print(exports)
```
