...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("read", "read", "/item/__/{item_id}", {"GET"}),
        ("update", "update", "/item/__/{item_id}", {"PATCH"}),
        ("replace", "replace", "/item/__/{item_id}", {"PUT"}),
        ("delete", "delete", "/item/__/{item_id}", {"DELETE"}),
        ("list", "list", "/item", {"GET"}),
        ("clear", "clear", "/item", {"DELETE"}),
        ("merge", "merge", "/item/__/{item_id}", {"PATCH"}),
