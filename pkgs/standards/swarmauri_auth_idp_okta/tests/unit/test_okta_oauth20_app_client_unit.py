...
@pytest.fixture
def client() -> OktaOAuth20AppClient:
    return OktaOAuth20AppClient(
...
@pytest.mark.unit
def test_resource(client: OktaOAuth20AppClient) -> None:
    assert client.resource == "OAuth20AppClient"


@pytest.mark.unit
def test_type(client: OktaOAuth20AppClient) -> None:
    assert client.type == "OktaOAuth20AppClient"


@pytest.mark.unit
def test_serialization(client: OktaOAuth20AppClient) -> None:
    dumped = json.loads(client.model_dump_json())
    cloned = OktaOAuth20AppClient.model_construct(**dumped)
