"""Okta OpenID Connect 1.0 Authorization Code login implementation."""
...
@ComponentBase.register_type(OIDC10LoginBase, "OktaOIDC10Login")
class OktaOIDC10Login(OktaOIDCLoginMixin, OIDC10LoginBase):
    """Implement OIDC 1.0 Authorization Code with PKCE for Okta."""
