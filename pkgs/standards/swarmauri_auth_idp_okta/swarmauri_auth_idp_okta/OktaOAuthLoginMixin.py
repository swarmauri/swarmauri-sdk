"""Shared helpers for Okta OAuth user login implementations."""
...
class OktaOAuthLoginMixin:
    """Reusable PKCE, discovery, and UserInfo helpers for Okta logins."""
