...
ROUTE_BINDING_MATCH = ROUTE_MATCH_REST
ROUTE_RPC_METHOD_MATCH = ROUTE_MATCH_JSONRPC
ROUTE_PATH_PARAMS_EXTRACT = ROUTE_PARAMS_NORMALIZE
ROUTE_BINDING_POLICY_APPLY = ROUTE_PAYLOAD_SELECT
ROUTE_PLAN_SELECT = ROUTE_OP_RESOLVE
