...
def _run(obj: object | None, ctx: Any) -> None:
    ...
    protocols = (
        [p for p in candidates if isinstance(p, str)]
    ...
    for proto in protocols:
        bucket = (
            proto_indices.get(proto) if isinstance(proto_indices, Mapping) else None
        )
                    ...
                    for entry in templated:
                        ...
                        if entry_method and entry_method != method:
                            ...
                            if (
                                ...
                                and hasattr(candidate_pattern, "match")
                                and candidate_pattern.match(path)
                            ):
