"""RFC 7592 client registration management tests using a live server."""
...
@pytest.mark.unit
@pytest.mark.asyncio
async def test_client_update_and_delete_available(running_app):
    """Clients can be updated and deleted via the service."""
    base = running_app
    async with httpx.AsyncClient() as client:
        ...
        assert update_resp.json()["client_name"] == "example"
