...
<p align="center">
    ...
    <a href="https://pypi.org/project/swarmauri_middleware_securityheaders/">
        <img src="https://img.shields.io/pypi/l/swarmauri_middleware_securityheaders" alt="License"/></a>
    <a href="https://pypi.org/project/swarmauri_middleware_securityheaders/">
        <img src="https://img.shields.io/pypi/v/swarmauri_middleware_securityheaders?label=swarmauri_middleware_securityheaders&color=green" alt="Release Version"/></a>
...
```bash
pip install swarmauri_middleware_securityheaders
```
