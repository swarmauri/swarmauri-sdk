"""GitHub OAuth 2.0 Authorization Code login implementation."""
...
@ComponentBase.register_type(OAuth20LoginBase, "GitHubOAuth20Login")
class GitHubOAuth20Login(GitHubOAuthLoginMixin, OAuth20LoginBase):
    """Implement the GitHub OAuth 2.0 Authorization Code flow with PKCE."""
