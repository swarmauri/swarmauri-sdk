...
<p align="center">
    ...
    <a href="https://pypi.org/project/swarmauri_transport_h2/">
        <img src="https://img.shields.io/pypi/l/swarmauri_transport_h2" alt="License"/></a>
    <a href="https://pypi.org/project/swarmauri_transport_h2/">
        <img src="https://img.shields.io/pypi/v/swarmauri_transport_h2?label=swarmauri_transport_h2&color=green" alt="Release Version"/></a>
    <a href="https://discord.gg/N4UpBuQv8T">
        <img src="https://img.shields.io/badge/Discord-Join%20Chat-5865F2?logo=discord&logoColor=white" alt="Discord"/></a>
</p>

# Swarmauri Transport HTTP/2
...
- HTTP/2 transport adapter built on the Swarmauri H2 mux.
- Centers its public API around `H2Transport` so downstream code can import the package directly without extra registry glue.
...
```bash
uv add swarmauri_transport_h2
```

```bash
pip install swarmauri_transport_h2
```
