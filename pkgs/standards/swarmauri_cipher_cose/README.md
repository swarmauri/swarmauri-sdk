...
<p align="center">
    <a href="https://pypi.org/project/swarmauri_cipher_cose/">
        <img src="https://img.shields.io/pypi/dm/swarmauri_cipher_cose" alt="PyPI - Downloads"/></a>
    <a href="https://hits.sh/github.com/swarmauri/swarmauri-sdk/tree/master/pkgs/standards/swarmauri_cipher_cose/">
        <img alt="Hits" src="https://hits.sh/github.com/swarmauri/swarmauri-sdk/tree/master/pkgs/standards/swarmauri_cipher_cose.svg"/></a>
    <a href="https://pypi.org/project/swarmauri_cipher_cose/">
        <img src="https://img.shields.io/pypi/pyversions/swarmauri_cipher_cose" alt="PyPI - Python Version"/></a>
    <a href="https://pypi.org/project/swarmauri_cipher_cose/">
        <img src="https://img.shields.io/pypi/l/swarmauri_cipher_cose" alt="PyPI - License"/></a>
    <a href="https://pypi.org/project/swarmauri_cipher_cose/">
        <img src="https://img.shields.io/pypi/v/swarmauri_cipher_cose?label=swarmauri_cipher_cose&color=green" alt="PyPI - swarmauri_cipher_cose"/></a>
</p>
...
```bash
pip install swarmauri_cipher_cose
```

### Poetry

```bash
poetry add swarmauri_cipher_cose
```
...
```bash
uv add swarmauri_cipher_cose
```

Or install it into the active environment:

```bash
uv pip install swarmauri_cipher_cose
```

## Usage

```python
from swarmauri_cipher_cose import CoseCipherSuite
