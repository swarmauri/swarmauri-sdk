# tigrbl/v3/mapping/__init__.py
"""
Tigrbl v3 – Mapping package.
...
Concerns are kept strictly separated:
  ...
  • System steps → injected by runtime lifecycle (Kernel), not by mapping
  • Atoms → discovered/injected by runtime, not by mapping
...
# Per-concern builders (aliased for a clean public Router)
