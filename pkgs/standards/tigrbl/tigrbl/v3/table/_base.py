...
def _materialize_colspecs_to_sqla(cls) -> None:
    ...
    """
    try:
        from tigrbl.v3.column.column_spec import ColumnSpec
    except Exception:
        return
...
class Base(DeclarativeBase):
    ...
    def __init_subclass__(cls, **kw):
        ...
        try:
            from tigrbl.v3.bindings import model as _model_bind
        ...
        try:
            from tigrbl.v3.schema.build import build_for_model as _build_schemas
