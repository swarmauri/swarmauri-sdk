# tigrbl/v3/__init__.py
"""
Tigrbl v3 – public API
...
Quick start:
    from tigrbl.v3 import include_model, build_jsonrpc_router, mount_diagnostics
    from tigrbl.v3 import OpSpec, hook_ctx, op_ctx, alias_ctx, schema_ctx, SchemaRef
