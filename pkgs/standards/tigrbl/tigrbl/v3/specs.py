...
Importing from ``tigrbl.v3.specs`` remains supported but the
implementation now lives under :mod:`tigrbl.v3.column`.
"""
...
# Allow submodule imports like ``tigrbl.v3.specs.storage_spec``
__path__: list[str] = []
