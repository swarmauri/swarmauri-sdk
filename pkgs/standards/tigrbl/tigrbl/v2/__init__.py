# tigrbl/v2/__init__.py
"""
Public façade for the Tigrbl framework.

•  Keeps only lightweight glue code.
•  Delegates real work to sub-modules (impl, hooks, endpoints, rpcdispatch, …).
•  Preserves the historical surface: Tigrbl._crud, …
"""
...
from .schema import _SchemaNS, get_tigrbl_schema as get_schema
...
# keep __all__ tidy for `from tigrbl import *` users
__all__ = [
    "Tigrbl",
    "Phase",
    "Base",
