...
Nothing else in Tigrbl needs to change.
"""
...
def register_transaction(
    ...
    *,
    ...
    ----------
    self:
        The :class:`Tigrbl` instance to bind to.
    rpc_id:
...
def transactional(  # ← bound per-instance in Tigrbl.__init__
    self,
