...
Collect Tigrbl configuration hooks by category.

This module groups the special Column.info keys, class attributes, and
runtime configuration names recognized by Tigrbl into high level
categories for easier reference.
"""

# Column-level configuration keys found in ``Column.info`` or ``info["tigrbl"]``
...
TAB_LEVEL_CFGS: set[str] = {
    ...
    "__tigrbl_response_extras__",
    "__tigrbl_register_hooks__",
    "__tigrbl_owner_policy__",
    "__tigrbl_tenant_policy__",
    "__tigrbl_nested_paths__",
    "__tigrbl_allow_anon__",
    "__tigrbl_verb_aliases__",
    "__tigrbl_verb_alias_policy__",
}
...
AUTH_CONTEXT_KEY = "__tigrbl_auth_context__"
INJECTED_FIELDS_KEY = "__tigrbl_injected_fields__"
