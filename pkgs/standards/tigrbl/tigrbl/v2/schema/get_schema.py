...
from tigrbl.v2.types import _SchemaVerb


@lru_cache(maxsize=None)
def get_tigrbl_schema(
    orm_cls: type,
    op: _SchemaVerb,
) -> type[BaseModel]:
    """
    >>> SCreate = get_tigrbl_schema(User, "create")
    >>> SListIn = get_tigrbl_schema(User, "list")
    The return value is *exactly* the model class Tigrbl generates
    ...
    def _schema(verb: str):
        return Tigrbl._schema(orm_cls, verb=verb)
