...
def test_gzipcompressionmiddleware_import() -> None:
    ...
    assert GzipCompressionMiddleware is not None, "GzipCompressionMiddleware not imported"
    assert isinstance(GzipCompressionMiddleware, type), "GzipCompressionMiddleware is not a class"
