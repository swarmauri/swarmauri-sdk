...
class DocumentNode(Node):
    ...
    def __eq__(self, other):
        ...
        if isinstance(other, DocumentNode):
            return (
                self.has_doc_start == other.has_doc_start and
                self.has_doc_end == other.has_doc_end and
                self.leading_comments == other.leading_comments and
                self.trailing_comments == other.trailing_comments and
    ...
    def __repr__(self):
        return (f"<DocumentNode doc_start={self.has_doc_start} "
...
class SequenceNode(Node):
    ...
    def __eq__(self, other):
        if isinstance(other, SequenceNode):
            ...
            converted = [item.value if hasattr(item, "value") else item for item in self.items]
            return converted == other
        return False
...
class ScalarNode(Node):
    ...
    def __repr__(self):
        return (f"<ScalarNode value={self.value!r} style={self.style!r} "
                f"tag={self.tag!r}>")
