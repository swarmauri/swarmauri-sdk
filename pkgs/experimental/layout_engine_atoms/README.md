...
<p align="center">
    ...
    <a href="https://pypi.org/project/layout_engine_atoms/">
        <img src="https://img.shields.io/pypi/l/layout_engine_atoms" alt="License"/></a>
    <a href="https://pypi.org/project/layout_engine_atoms/">
        <img src="https://img.shields.io/pypi/v/layout_engine_atoms?label=layout_engine_atoms&color=green" alt="Release Version"/></a>
...
Curated atom presets and registries for layout-engine.
...
```bash
uv add layout_engine_atoms
```

```bash
pip install layout_engine_atoms
```
