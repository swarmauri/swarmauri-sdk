"""Build the manifest for the SwarmaKit Vue landing page demo."""
...
from layout_engine_atoms.catalog import swarma_vue
...
def create_manifest() -> Mapping[str, Any]:
    ...
    tiles: list[TileSpec] = [
            ...
            props={
                "cards": [
                    ...
                    },
                    {
                        ...
                        "description": "Deploy SwarmaKit atoms in Vue apps with live data, theming, and realtime updates baked in.",
                    },
                    {
        ...
        TileSpec(
            id="tile_roadmap",
            role="swarmakit:vue:timeline-list",
            props={
                "items": [
        ...
        TileSpec(
            id="tile_navigation",
            role="swarmakit:vue:contextual-navigation",
            props={
                "menuItems": [
        ...
        TileSpec(
            id="tile_cta",
            role="swarmakit:vue:system-alert-global-notification-bar",
            props={
                "type": "info",
                "message": "Book a live walkthrough to see SwarmaKit components inside your Vue workflows.",
            },
        ),
    ]
    ...
    payload.setdefault("label", "SwarmaKit Landing")
    payload.setdefault("title", "SwarmaKit Landing Page")
    payload.setdefault(
        "theme",
        {
            "tokens": {
