...
export const LineChartCard = defineComponent({
  name: "LineChartCard",
  props: {
    tile: { type: Object, required: true },
  },
...
export const TableCard = defineComponent({
  name: "TableCard",
  props: {
    tile: { type: Object, required: true },
  },
...
export const PlaceholderCard = defineComponent({
  ...
  setup(props) {
    return () =>
      h("div", { class: "placeholder-card" }, [
        ...
        h("pre", null, JSON.stringify(props.tile.props, null, 2)),
      ]);
  },
});

export const atomRenderers = {
