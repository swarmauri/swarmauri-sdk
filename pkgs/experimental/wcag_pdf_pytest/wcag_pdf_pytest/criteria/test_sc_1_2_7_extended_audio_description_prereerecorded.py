...
SC_NUM = "1.2.7"
SC_TITLE = "Extended Audio Description (Prereerecorded)"
SC_LEVEL = "AAA"
...
@pytest.mark.wcag21
@pytest.mark.AAA
def test_sc_1_2_7____(wcag_pdf_paths):
    """WCAG 2.1 SC 1.2.7: Extended Audio Description (Prereerecorded) (Level AAA).
