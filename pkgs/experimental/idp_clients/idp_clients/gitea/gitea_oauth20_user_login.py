...
class GiteaOAuth20Login:
    """OAuth 2.0 Authorization Code + PKCE for Gitea; identity from REST API."""
    base_url: str
    client_id: str
    client_secret: str
    redirect_uri: str
    ...
    async def exchange_and_profile(self, code: str, state: str) -> Dict[str, Any]:
        ...
        return {"issuer":"gitea-oauth2", "sub": str(me.get("id")), "email": email, "name": name,
