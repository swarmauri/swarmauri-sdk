...
class FacebookOIDC10Login:
    """OpenID Connect 1.0 Authorization Code + PKCE for Facebook (if OIDC is enabled for your app).

    issuer: typically "https://www.facebook.com"
    """
    issuer: str = "https://www.facebook.com"
    client_id: str = ""
    client_secret: str = ""
    redirect_uri: str = ""
    state_secret: bytes = b""
    scope: str = "openid email public_profile"
    ...
    async def exchange(self, code: str, state: str) -> Dict[str, Any]:
        ...
        return {"issuer":"facebook-oidc", "sub": claims["sub"], "email": email, "name": name, "raw":{"tokens": tok}}
