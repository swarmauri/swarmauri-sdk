...
class KeycloakOIDC10Login:
    """OpenID Connect 1.0 Authorization Code + PKCE for Keycloak.
    ...
    async def exchange(self, code: str, state: str) -> Dict[str, Any]:
        ...
        # Minimal identity with optional UserInfo fallback
        ...
        return {"issuer":"keycloak-oidc", "sub": claims["sub"], "email": email, "name": name, "raw": {"tokens": tok}}
