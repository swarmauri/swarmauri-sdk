...
class CognitoOAuth21AppClient:
    """OAuth 2.1-aligned client-credentials for AWS Cognito.

    token_url is {base_url}/oauth2/token. Some client-auth methods may vary by setup.
    """
    base_url: str
    client_id: str
