...
class AwsWorkforceOAuth21Login:
    authorization_endpoint: str   # from RegisterClient
    token_endpoint: str           # from RegisterClient
    client_id: str                # from RegisterClient
    client_secret: str            # from RegisterClient
    redirect_uri: str
    state_secret: bytes
