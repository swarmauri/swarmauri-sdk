...
API_ROUTES = [
    {"method": "GET", "path": "/.well-known/acme-directory", "handler": "schema.directory_extra:build_directory"},
    ...
    {"method": "POST", "path": "/acme/new-account", "handler": "tables.Account:new_account"},
