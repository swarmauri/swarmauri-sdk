...
from .engines.postgres_wal_engine import build_postgres_wal_engine, postgres_wal_capabilities
...
def register() -> None:
    ...
    register_engine("postgres_wal", build_postgres_wal_engine, postgres_wal_capabilities)
