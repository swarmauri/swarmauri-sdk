...
class MatplotlibCsvTool(ToolBase):
    ...
    name: str = Field("MatplotlibCsvTool", description="Tool to generate plots from CSV data using Matplotlib.")
    ...
    def run(self, csv_file: str, x_column: str, y_column: str, output_file: str):
        ...
        if x_column not in data.columns or y_column not in data.columns:
            raise ValueError(f"Columns {x_column} and/or {y_column} not found in the CSV file.")
